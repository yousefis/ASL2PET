...
def submit_job(fold):
    ...
    main_script = '/run_hybrid_multitask_net_hr_residual_attention2_UnetSkipAttention_not1.py'


    # Slurm
    setting['cluster_MemPerCPU'] = 4200#4200   #2200  # 6200
    ...
    job_name = 'f'+str(fold)+'_att2_'+ext+'_'+str(backup_number)
...
def write_and_submit_job(setting, manager, job_name, script_address,fold):
    ...
    backup_folder='Log_asl_pet/rest/01_cross_validation/resi_skip_att_not1/residual_skip_not1_fold_'+str(fold)+'/'
