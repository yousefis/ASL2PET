...
def submit_job():
    ...
    main_script = '/run_hybrid_multitask_net_hr_residual_rest.py'
    ...
    job_name = 'ASLRes'+ext+'_'+str(backup_number)
...
def write_and_submit_job(setting, manager, job_name, script_address):
    ...
    backup_folder='Log_asl_pet/rest/denseunet_hybrid_hr_residual_01/'
