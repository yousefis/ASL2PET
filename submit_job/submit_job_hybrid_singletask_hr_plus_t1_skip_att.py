...
def submit_job(fold):
    ...
    main_script = '/run_hybrid_singletask_net_hr_plust1_skip_att.py'
    ...
    job_name = 'STskp_'+str(fold)+'_'+ext+'_'+str(backup_number)
...
def write_and_submit_job(setting, manager, job_name, script_address,fold):
    ...
    backup_folder = 'Log_asl_pet/rest/01_cross_validation/single_plust1_skipatt/single_plust1_skipatt_fold_' + str(fold) + '/'
