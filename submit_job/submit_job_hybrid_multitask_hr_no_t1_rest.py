...
def submit_job(fold):
    ...
    main_script = '/run_hybrid_multitask_net_hr_not1_rest.py'
    ...
    job_name = 'noskipt1_'+str(fold)+'_'+ext+'_'+str(backup_number)
...
def write_and_submit_job(setting, manager, job_name, script_address,fold):
    ...
    backup_folder='/Log_asl_pet/rest/01_cross_validation/multitask_not1/denseunet_hybrid_not1_0' + str(fold) + '/'
