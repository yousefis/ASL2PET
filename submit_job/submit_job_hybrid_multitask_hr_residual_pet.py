...
def submit_job():
    ...
    net_config = [1, 3, 3, 3, 1]
    main_script = '/run_hybrid_multitask_net_hr_residual_pet.py'
    ...
    job_name = 'ResdPET'+ext+'_'+str(backup_number)
...
def write_and_submit_job(setting, manager, job_name, script_address):
    ...
    backup_folder='Log_asl_pet/denseunet_hybrid_hr_residual_pet_01/'
...
def backup_script(script_address, main_script, folder_script, net_config):
    ...
    backup_root_folder = script_folder + '/0_Log_asl_pet/net'+ext+'/'
