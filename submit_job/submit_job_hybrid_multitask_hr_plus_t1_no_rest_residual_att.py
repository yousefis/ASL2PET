...
def submit_job(fold):
    ...
    main_script = '/run_hybrid_multitask_net_hr_plust1_no_residual_att.py'
    ...
    job_name = '+t1-att_'+str(fold)+'_'+ext+'_'+str(backup_number)
...
def write_and_submit_job(setting, manager, job_name, script_address,fold):
    ...
    backup_folder='Log_asl_pet/rest/01_cross_validation/plust1_noskippatt_noresidualatt/residual_attention2_plust1_no_resid_noskip_fold_' + str(fold) + '/'
