...
from functions.network_caller.hybrid_single_task_translate_hr_plust1_rest_no_residual_att import net_translate
import numpy as np
...
if __name__ == '__main__':
    ...
    Logs = 'Log_asl_pet/rest/01_cross_validation/single_plust1/single_plust1_fold_' + str(fold) + '/'
