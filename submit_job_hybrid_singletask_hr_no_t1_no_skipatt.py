...
def submit_job(fold):
    ...
    main_script = '/run_hybrid_singletask_net_hr_not1_no_skipatt.py'
...
def write_and_submit_job(setting, manager, job_name, script_address,fold):
    ...
    backup_folder= 'Log_asl_pet/rest/01_cross_validation/single_not1_2/single_not1_fold_' + str(fold) + '/'
