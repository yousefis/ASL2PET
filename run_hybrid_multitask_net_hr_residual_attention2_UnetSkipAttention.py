...
from functions.network_caller.hybrid_multi_task_translate_hr_residual_attention2_UnetSkipAttention import net_translate
import numpy as np
...
if __name__ == '__main__':
    ...
    Logs = 'Log_asl_pet/rest/cross_validation_unetskipatt/residual_attention2_UnetSkipAttention'+str(fold)+'/'
