...
def submit_job(fold):
    ...
    main_script = '/run_hybrid_multitask_net_hr_residual_attention2_UnetSkipAttention.py'
...
def write_and_submit_job(setting, manager, job_name, script_address,fold):
    ...
    backup_folder='Log_asl_pet/rest/cross_val_att2/residual_attention2_fold_'+str(fold)+'/'
