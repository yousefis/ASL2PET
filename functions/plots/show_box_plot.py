...
if __name__=='__main__':
    parent_pth='/exports/lkeb-hpc/syousefi/Code/Log_asl_pet/rest/cross_val_att2/'
    parent_pth='/exports/lkeb-hpc/syousefi/Code/Log_asl_pet/rest/00_cross_validation/'
    fold=1
    xls_path=[
              # 'residual_attention2_fold_1/',
              # 'residual_attention2_fold_2/',
              'singletask/residual_attention2_not1_no_residualatt_fold_' + str(fold) + '/', #single task
              'not1_noskippatt/residual_attention2_not1_fold_'+str(fold)+'/', #multi task +t1
              # 'not1_noskippatt_noresidualatt/residual_attention2_not1_no_residualatt_fold_'+str(fold)+'/',
              'witht1_no_skipatt/residual_attention2_fold_'+str(fold)+'/',
              'witht1_skipatt/residual_attention2_UnetSkipAttention'+str(fold)+'/',
              ]
    cnn_tags=['F1',
              'F2',
              'F3',
