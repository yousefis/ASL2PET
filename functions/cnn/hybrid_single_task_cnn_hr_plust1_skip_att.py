...
class multi_stage_densenet:
    ...
    def multi_stage_densenet(self, asl_img, t1_img,pet_img,  input_dim, is_training,config,hybrid_training_flag,conv_transpose=True):
        ...
        with tf.variable_scope('stack-contact'):
            ...
            stack_concat = tf.concat([stack_concat, asl_img], -1)
            stack_concat = tf.concat([stack_concat, t1_img], -1)
        ...
        skip_channel_attention2 = self.channel_attention(name='skip_channel_attention2', input=crop1)
