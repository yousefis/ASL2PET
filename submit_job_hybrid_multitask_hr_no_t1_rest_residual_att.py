...
def submit_job(fold):
    ...
    main_script = '/run_hybrid_multitask_net_hr_not1_rest_no_residual_att.py'
...
def write_and_submit_job(setting, manager, job_name, script_address,fold):
    ...
    backup_folder='Log_asl_pet/rest/01_cross_validation/not1_noskippatt_noresidualatt/residual_attention2_not1_no_residualatt_fold_' + str(fold) + '/'
