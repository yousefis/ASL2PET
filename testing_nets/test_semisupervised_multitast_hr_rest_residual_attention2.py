...
def test_all_nets(out_dir, Log, which_data,fold ):
    ...
    _meas = _measure()
    copyfile('./test_semisupervised_multitast_hr_rest_residual_attention2.py',
             parent_path + Log + out_dir + 'test_semisupervised_multitast_hr_rest_residual_attention2.py')
...
if __name__ == "__main__":
    ...
    Log = "Log_asl_pet/rest/cross_val_att2/residual_attention2_fold_" + str(fold) + "/"
    which_data = 2
    if which_data == 1:
