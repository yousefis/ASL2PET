...
def test_all_nets(out_dir, Log, which_data):
    ...
    _meas = _measure()
    copyfile('./test_semisupervised_multitast_hr_rest.py',
             parent_path + Log + out_dir + 'test_semisupervised_multitast_hr_rest.py')
...
if __name__ == "__main__":
    Log = "Log_asl_pet/rest/residual_attention/"
    which_data = 1
    if which_data == 1:
