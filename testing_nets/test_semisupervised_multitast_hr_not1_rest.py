...
def test_all_nets(out_dir, Log, which_data):
    ...
    _meas = _measure()
    copyfile('./test_semisupervised_multitast_hr_not1_rest.py',
             parent_path + Log + out_dir + 'test_semisupervised_multitast_hr_not1_rest.py')
...
if __name__ == "__main__":
    Log = "Log_asl_pet/rest/denseunet_hybrid_hr_not1_03_weight/"
    which_data = 2
    if which_data == 1:
        out_dir = "0_vali_result/"
    elif which_data == 2:
        out_dir = "0_test_result1/"
    elif which_data == 3:
