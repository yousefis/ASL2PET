...
from functions.reader.data_reader_singletask import _read_data
# from functions.cnn.hybrid_multi_task_cnn import multi_stage_densenet
from functions.cnn.hybrid_single_task_cnn_hr_plust1_no_residual_att import multi_stage_densenet
...
def test_all_nets(out_dir, Log, which_data,fold):
    ...
    saver.restore(sess, chckpnt_dir + 'densenet_unet_inter_epoch0_point4000.ckpt-4000')
    _meas = _measure()
    copyfile('./test_single_task_plust1_noresdatt.py',
             parent_path + Log + out_dir + 'test_single_task_plust1_noresdatt.py')
...
if __name__ == "__main__":
    fold=5
    # Log = "Log_asl_pet/rest/00_cross_validation/witht1_skipatt/residual_attention2_UnetSkipAttention"+str(fold)+"/"
    Log = "Log_asl_pet/rest/01_cross_validation/single_plust1/single_plust1_fold_"+str(fold)+"/"
    which_data = 1
    if which_data == 1:
