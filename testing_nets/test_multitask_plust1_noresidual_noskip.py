...
def test_all_nets(out_dir, Log, which_data,fold):
    ...
    # saver.restore(sess, chckpnt_dir+'densenet_unet_inter_epoch0_point8000.ckpt-8000')
    _meas = _measure()
...
if __name__ == "__main__":
    ...
    Log = "Log_asl_pet/rest/01_cross_validation/plust1_noskippatt_noresidualatt/residual_attention2_plust1_no_resid_noskip_fold_" + str(fold) + "/"
    which_data = 1
    if which_data == 1:
