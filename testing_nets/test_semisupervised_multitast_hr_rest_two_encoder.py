...
from functions.cnn.hybrid_multi_task_cnn_hr_two_encoder import multi_stage_densenet
...
def test_all_nets(out_dir, Log, which_data):
    ...
    _meas = _measure()
    copyfile('./test_semisupervised_multitast_hr_rest_two_encoder.py',
             parent_path + Log + out_dir + 'test_semisupervised_multitast_hr_rest_two_encoder.py')
...
if __name__ == "__main__":
    Log = "Log_asl_pet/rest/denseunet_two_encoder/"
    which_data = 2
    if which_data == 1:
