...
def test_all_nets(out_dir, Log, which_data):
    ...
    _meas = _measure()
    copyfile('./test_semisupervised_multitast_hr_rest_residual_asl.py',
             parent_path + Log + out_dir + 'test_semisupervised_multitast_hr_rest_residual_asl.py')
...
if __name__ == "__main__":
    Log = "Log_asl_pet/rest/denseunet_hybrid_hr_residual_01/"
    which_data = 2
    if which_data == 1:
