...
# from functions.network_caller.hybrid_multi_task_translate_hr_not1_rest import net_translate
from functions.network_caller.hybrid_multi_task_translate_hr_not1_rest import net_translate
import numpy as np
...
if __name__ == '__main__':
    ...
    # Logs = 'Log_asl_pet/rest/00_cross_validation/not1_noskippatt/residual_attention2_not1_fold_' + str(fold) + '/'
    # Logs = 'Log_asl_pet/rest/denseunet_hybrid_hr_not1_01/'
    Logs = '/Log_asl_pet/rest/01_cross_validation/multitask_not1/denseunet_hybrid_not1_0' + str(fold) + '/'
    # use mixed precision
