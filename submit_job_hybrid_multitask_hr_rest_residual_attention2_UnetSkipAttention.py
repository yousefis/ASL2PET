...
def submit_job(fold):
    ...
    setting['cluster_NumberOfCPU'] = 4#7#10 #3               # Number of CPU per job
...
def write_and_submit_job(setting, manager, job_name, script_address,fold):
    ...
    backup_folder='Log_asl_pet/rest/cross_validation_unetskipatt/residual_attention2_UnetSkipAttention'+str(fold)+'/'
