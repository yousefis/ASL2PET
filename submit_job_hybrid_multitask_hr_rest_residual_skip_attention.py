...
def submit_job():
    ...
    main_script = '/run_hybrid_multitask_net_hr_residual_skip_attention.py'
    ...
    setting['cluster_NumberOfCPU'] = 6#7#10 #3               # Number of CPU per job
    ...
    job_name = 'skip_attention'+ext+'_'+str(backup_number)
...
def write_and_submit_job(setting, manager, job_name, script_address):
    ...
    backup_folder='Log_asl_pet/rest/residual_skip_attention_nocompress/'
