...
from functions.network_caller.hybrid_multi_task_translate_hr_residual_attention2 import net_translate
import numpy as np
...
if __name__ == '__main__':
    ...
    fold=6
    Logs = 'Log_asl_pet/rest/cross_validation/residual_resid_skip_attention_0'+str(fold)+'/'
