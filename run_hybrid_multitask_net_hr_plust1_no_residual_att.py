...
from functions.network_caller.hybrid_multi_task_translate_hr_plust1_no_residual_att import net_translate
import numpy as np
...
if __name__ == '__main__':
    ...
    Logs = 'Log_asl_pet/rest/01_cross_validation/plust1_noskippatt_noresidualatt/residual_attention2_plust1_no_resid_noskip_fold_' + str(fold) + '/'
