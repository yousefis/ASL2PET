...
from functions.network_caller.hybrid_single_task_translate_hr_not1_rest_no_skipatt import net_translate
import numpy as np
...
if __name__ == '__main__':
    ...
    Logs = 'Log_asl_pet/rest/01_cross_validation/single_not1_2/single_not1_fold_' + str(fold) + '/'
