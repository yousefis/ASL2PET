...
from functions.network_caller.hybrid_multi_task_translate_hr_not1_rest_no_residual_att import net_translate
import numpy as np
...
if __name__ == '__main__':
    ...
    Logs = 'Log_asl_pet/rest/01_cross_validation/not1_noskippatt_noresidualatt/residual_attention2_not1_no_residualatt_fold_' + str(fold) + '/'
