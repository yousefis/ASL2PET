...
from functions.network_caller.hybrid_multi_task_translate_hr_residual_skip_attention import net_translate
import numpy as np
...
if __name__ == '__main__':
    ...
    Logs = 'Log_asl_pet/rest/residual_skip_attention_nocompress/'
